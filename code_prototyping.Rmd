...
```{r}
selectBenchmarks3 <- "PctFinesLessThan2mm"
selectBenchmarks2 <- "LgWoodInChanFreq"

cond2 <- dplyr::filter(bm, Indicator == selectBenchmarks3 & ConditionCategoryNum == 3)
cond3 <- dplyr::filter(bm, Indicator == selectBenchmarks2 & ConditionCategoryNum == 2)
